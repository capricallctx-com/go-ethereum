...
const (
	...
	TxGas                 uint64 = 10    // Base transaction in wei, plus byte gas for tanker use
	TankerTariffKB        uint64 = 100   // price per kb of tanker data
	...
	CargoClaimTwitter     byte   = 0x01
	CargoClaimHaya        byte   = 0x02
	CargoAttest           byte   = 0x03
